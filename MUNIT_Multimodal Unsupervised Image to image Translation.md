...
첫 번째 이미지에서 추출된 content code <그림12>   과
두 번째 도메인에 해당하는 style code <그림13> 를 활용해서
Image translation <그림14> 를 수행한다. 즉, 비록 <그림15> 은 unimodal distribution 이지만, decoder의 non-linearity 덕분에 생성되는 translation image는 multimodal이 될 수 있다. <그림16>
...
<그림 21>
 ...
 이는 이미지 quality 뿐만 아니라 diversity에서도 확인이 되는데, 특히 위에서 언급했던 loss를 일부 적용하는 ablation study에서도 MUNIT의 우수성을 확인 할수가 있다. 
